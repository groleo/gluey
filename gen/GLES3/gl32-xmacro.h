...
XMACRO(void, glBlendBarrier)
XMACRO(void, glCopyImageSubData, GLuint srcName,GLenum srcTarget,GLint srcLevel,GLint srcX,GLint srcY,GLint srcZ,GLuint dstName,GLenum dstTarget,GLint dstLevel,GLint dstX,GLint dstY,GLint dstZ,GLsizei srcWidth,GLsizei srcHeight,GLsizei srcDepth)
XMACRO(void, glDebugMessageControl, GLenum source,GLenum type,GLenum severity,GLsizei count,const GLuint *ids,GLboolean enabled)
XMACRO(void, glDebugMessageInsert, GLenum source,GLenum type,GLuint id,GLenum severity,GLsizei length,const GLchar *buf)
XMACRO(void, glDebugMessageCallback, GLDEBUGPROC callback,const void *userParam)
XMACRO(GLuint, glGetDebugMessageLog, GLuint count,GLsizei bufSize,GLenum *sources,GLenum *types,GLuint *ids,GLenum *severities,GLsizei *lengths,GLchar *messageLog)
XMACRO(void, glPushDebugGroup, GLenum source,GLuint id,GLsizei length,const GLchar *message)
XMACRO(void, glPopDebugGroup)
XMACRO(void, glObjectLabel, GLenum identifier,GLuint name,GLsizei length,const GLchar *label)
XMACRO(void, glGetObjectLabel, GLenum identifier,GLuint name,GLsizei bufSize,GLsizei *length,GLchar *label)
XMACRO(void, glObjectPtrLabel, const void *ptr,GLsizei length,const GLchar *label)
XMACRO(void, glGetObjectPtrLabel, const void *ptr,GLsizei bufSize,GLsizei *length,GLchar *label)
XMACRO(void, glGetPointerv, GLenum pname,void **params)
XMACRO(void, glEnablei, GLenum target,GLuint index)
XMACRO(void, glDisablei, GLenum target,GLuint index)
XMACRO(void, glBlendEquationi, GLuint buf,GLenum mode)
XMACRO(void, glBlendEquationSeparatei, GLuint buf,GLenum modeRGB,GLenum modeAlpha)
XMACRO(void, glBlendFunci, GLuint buf,GLenum src,GLenum dst)
XMACRO(void, glBlendFuncSeparatei, GLuint buf,GLenum srcRGB,GLenum dstRGB,GLenum srcAlpha,GLenum dstAlpha)
XMACRO(void, glColorMaski, GLuint index,GLboolean r,GLboolean g,GLboolean b,GLboolean a)
XMACRO(GLboolean, glIsEnabledi, GLenum target,GLuint index)
XMACRO(void, glDrawElementsBaseVertex, GLenum mode,GLsizei count,GLenum type,const void *indices,GLint basevertex)
XMACRO(void, glDrawRangeElementsBaseVertex, GLenum mode,GLuint start,GLuint end,GLsizei count,GLenum type,const void *indices,GLint basevertex)
XMACRO(void, glDrawElementsInstancedBaseVertex, GLenum mode,GLsizei count,GLenum type,const void *indices,GLsizei instancecount,GLint basevertex)
XMACRO(void, glFramebufferTexture, GLenum target,GLenum attachment,GLuint texture,GLint level)
XMACRO(void, glPrimitiveBoundingBox, GLfloat minX,GLfloat minY,GLfloat minZ,GLfloat minW,GLfloat maxX,GLfloat maxY,GLfloat maxZ,GLfloat maxW)
XMACRO(GLenum, glGetGraphicsResetStatus)
XMACRO(void, glReadnPixels, GLint x,GLint y,GLsizei width,GLsizei height,GLenum format,GLenum type,GLsizei bufSize,void *data)
XMACRO(void, glGetnUniformfv, GLuint program,GLint location,GLsizei bufSize,GLfloat *params)
XMACRO(void, glGetnUniformiv, GLuint program,GLint location,GLsizei bufSize,GLint *params)
XMACRO(void, glGetnUniformuiv, GLuint program,GLint location,GLsizei bufSize,GLuint *params)
XMACRO(void, glMinSampleShading, GLfloat value)
XMACRO(void, glPatchParameteri, GLenum pname,GLint value)
XMACRO(void, glTexParameterIiv, GLenum target,GLenum pname,const GLint *params)
XMACRO(void, glTexParameterIuiv, GLenum target,GLenum pname,const GLuint *params)
XMACRO(void, glGetTexParameterIiv, GLenum target,GLenum pname,GLint *params)
XMACRO(void, glGetTexParameterIuiv, GLenum target,GLenum pname,GLuint *params)
XMACRO(void, glSamplerParameterIiv, GLuint sampler,GLenum pname,const GLint *param)
XMACRO(void, glSamplerParameterIuiv, GLuint sampler,GLenum pname,const GLuint *param)
XMACRO(void, glGetSamplerParameterIiv, GLuint sampler,GLenum pname,GLint *params)
XMACRO(void, glGetSamplerParameterIuiv, GLuint sampler,GLenum pname,GLuint *params)
XMACRO(void, glTexBuffer, GLenum target,GLenum internalformat,GLuint buffer)
XMACRO(void, glTexBufferRange, GLenum target,GLenum internalformat,GLuint buffer,GLintptr offset,GLsizeiptr size)
XMACRO(void, glTexStorage3DMultisample, GLenum target,GLsizei samples,GLenum internalformat,GLsizei width,GLsizei height,GLsizei depth,GLboolean fixedsamplelocations)
